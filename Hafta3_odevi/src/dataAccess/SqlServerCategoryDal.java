...
public class SqlServerCategoryDal implements IDataAccessCategoryDal,IDataListView {

	@Override
	public void add(category category) {
		// TODO Auto-generated method stub
		System.out.println("Kategori SqlServer veri tabanına eklendi : " + category.getCategoryId() + ")" + category.getCategoryName());
